...
class x_cp2k_section_dbcsr(MSection):
    ...
    m_def = Section(
        validate=False, a_legacy=LegacyDefinition(name="x_cp2k_section_dbcsr")
    )
...
class x_cp2k_section_global_settings(MSection):
    ...
    m_def = Section(
        validate=False, a_legacy=LegacyDefinition(name="x_cp2k_section_global_settings")
    )
...
class x_cp2k_section_scf_iteration(MSection):
    ...
    m_def = Section(
        validate=False, a_legacy=LegacyDefinition(name="x_cp2k_section_scf_iteration")
    )
...
class x_cp2k_section_end_information(MSection):
    ...
    m_def = Section(
        validate=False, a_legacy=LegacyDefinition(name="x_cp2k_section_end_information")
    )
...
class x_cp2k_section_stress_tensor(MSection):
    ...
    m_def = Section(
        validate=False, a_legacy=LegacyDefinition(name="x_cp2k_section_stress_tensor")
    )
...
class x_cp2k_section_total_numbers(MSection):
    ...
    m_def = Section(
        validate=False, a_legacy=LegacyDefinition(name="x_cp2k_section_total_numbers")
    )
...
class x_cp2k_section_md_settings(MSection):
    ...
    m_def = Section(
        validate=False, a_legacy=LegacyDefinition(name="x_cp2k_section_md_settings")
    )
...
class x_cp2k_section_md_step(MSection):
    ...
    m_def = Section(
        validate=False, a_legacy=LegacyDefinition(name="x_cp2k_section_md_step")
    )
...
class x_cp2k_section_atomic_kinds(MSection):
    ...
    m_def = Section(
        validate=False, a_legacy=LegacyDefinition(name="x_cp2k_section_atomic_kinds")
    )
...
class x_cp2k_section_vdw_settings(MSection):
    ...
    m_def = Section(
        validate=False, a_legacy=LegacyDefinition(name="x_cp2k_section_vdw_settings")
    )
...
class x_cp2k_section_vdw_d2_settings(MSection):
    ...
    m_def = Section(
        validate=False, a_legacy=LegacyDefinition(name="x_cp2k_section_vdw_d2_settings")
    )
...
class x_cp2k_section_vdw_d3_settings(MSection):
    ...
    m_def = Section(
        validate=False, a_legacy=LegacyDefinition(name="x_cp2k_section_vdw_d3_settings")
    )
...
class x_cp2k_section_atomic_kind(MSection):
    ...
    m_def = Section(
        validate=False, a_legacy=LegacyDefinition(name="x_cp2k_section_atomic_kind")
    )
...
class x_cp2k_section_kind_basis_set(MSection):
    ...
    m_def = Section(
        validate=False, a_legacy=LegacyDefinition(name="x_cp2k_section_kind_basis_set")
    )
